<?php
// Archivo: includes/login_process.php

session_start();
require_once 'db.php';

// Este archivo se encarga de procesar el formulario de inicio de sesión

if ($_SERVER["REQUEST_METHOD"] === "POST") {
    // Verificar que se hayan enviado ambos campos
    if (isset($_POST['correo']) && isset($_POST['password'])) {
        $correo = trim($_POST['correo']); // Quitar espacios por si el usuario los pone al inicio o final
        ...
        if ($usuario && password_verify($password, $usuario['password'])) {
            ...
            echo "<p>Correo o contraseña incorrectos. <a href='../public/login.php'>Volver</a></p>";
        }
    } else {
        // Si no llegaron todos los campos desde el formulario
        echo "<p>Faltan campos requeridos. <a href='../public/login.php'>Volver</a></p>";
    }
} else {
