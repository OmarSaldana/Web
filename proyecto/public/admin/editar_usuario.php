<?php
// Archivo: public/admin/editar_usuario.php
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Solo permitir los roles válidos que ya definí (1 = admin, 2 = usuario)
...
<section class="section">
    <div class="container">
        ...
        <form method="POST">
            <!-- Mostrar el nombre completo del usuario en campo solo lectura -->
            <div class="field">
