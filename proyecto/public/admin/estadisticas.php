<?php
// Archivo: public/admin/estadisticas.php
...
// Recoger el total de registros en su historial para calcular porcentaje
...
// Calcular el porcentaje de cumplimiento solo si hay registros
...
<head>
  ...
  <!-- Para los íconos de la flecha -->
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
  <!-- Archivos CSS propios del admin -->
  <link rel="stylesheet" href="../admin/styles_admin/styles_editar_usuario.css">
  <link rel="stylesheet" href="../admin/styles_admin/styles_admin.css">
</head>
<body>
  <!-- Header fijo con el logo -->
  ...
  <section class="section">
    <div class="container">
      ...
      <!-- Muestra de estadísticas con diseño limpio -->
