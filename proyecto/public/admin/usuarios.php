...
<body>
  ...
  <section class="section">
    <div class="container">
      ...
      <!-- Alertas según la acción realizada -->
      <?php if ($actualizado): ?>
            ...
            <?php foreach ($usuarios as $usuario): ?>
              <tr>
                ...
                <td class="buttons are-small">
                  ...
                  <a href="habitos.php?id_usuario=<?= $usuario['id_usuario'] ?>" class="button is-info is-light">Ver hábitos</a>
                  <a href="metas.php?id_usuario=<?= $usuario['id_usuario'] ?>" class="button is-link is-light">Ver metas</a>
                  <a href="estadisticas.php?id_usuario=<?= $usuario['id_usuario'] ?>" class="button is-success is-light">Estadísticas</a>
