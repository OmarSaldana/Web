    ...
    <main>
        <section class="section">
            <div class="container">
                ...
                <div class="buttons mt-4">
                    <a href="habits/index.php" class="button is-link">Mis Hábitos</a>
                    <a href="metas/index.php" class="button is-info">Mis Metas</a>
                    <a href="habits/historial.php" class="button is-success">Historial de Hábitos</a>
                    <a href="habits/reporte_semanal.php" class="button is-warning">Reporte Semanal</a>
                </div>
            </div>
        </section>
    </main>
