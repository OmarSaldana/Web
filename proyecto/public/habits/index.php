<?php
// Archivo: public/habits/index.php
...
// Traer todos los hábitos del usuario, incluyendo la categoría y frecuencia con JOINs
...
// También verificar cuáles hábitos ya fueron completados el día de hoy
$hoy = date('Y-m-d');
...
<body>
    ...
    <section class="section">
        <div class="container">
            ...
            <!-- Mensajes de retroalimentación por acciones -->
            ...
            <!-- Vista si no hay hábitos registrados -->
            <?php if (empty($habitos)): ?>
                <div class="no-habits">
                    ...
                    <a href="create.php" class="button is-primary is-medium">
                        <span class="icon"><i class="fas fa-plus"></i></span>
                        <span>Crear mi primer hábito</span>
                    </a>
                </div>
            <?php else: ?>
                <!-- Recorrer los hábitos y mostrar en tarjetas -->
                            ...
                            <div class="card">
                                ...
                                <footer class="card-footer">
                                    <div class="card-footer-item habit-actions">
                                        <a href="edit.php?id=<?= $habito['id_habito']; ?>" class="button is-info is-small">
                                            <span class="icon"><i class="fas fa-edit"></i></span>
                                            <span>Editar</span>
                                        </a>
                                        <a href="delete.php?id=<?= $habito['id_habito']; ?>" class="button is-danger is-small"
                                           onclick="return confirm('¿Estás seguro de que deseas eliminar este hábito?')">
                                            <span class="icon"><i class="fas fa-trash"></i></span>
                                            <span>Eliminar</span>
                                        </a>
                                        <!-- Mostrar botón de marcar como completado si no se ha hecho hoy -->
                                        <?php if (!in_array($habito['id_habito'], $completados_hoy)): ?>
                                            <a href="mark_complete.php?id=<?= $habito['id_habito']; ?>" class="button is-success is-small">
