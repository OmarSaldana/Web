<?php
// Archivo: public/habits/reporte_semanal.php

session_start();
require_once '../../includes/db.php';

// Si el usuario no está autenticado, mandar a login
...
// Primero sacar los hábitos activos del usuario para mostrarlos en el reporte
