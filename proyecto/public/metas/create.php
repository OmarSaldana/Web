<?php
// Archivo: public/metas/create.php

session_start();

// Asegurar que solo un usuario autenticado pueda acceder a esta página
...
if (empty($habitos)) {
    ...
    echo '<a href="../habits/create.php">Crear hábito</a>';
    exit;
}
?>
...
<head>
    ...
    <link rel="stylesheet" href="styles_metas/styles_create.css">
</head>
<body>
    <!-- Header -->
    ...
    <main>
        <section class="section">
            <div class="container">
                ...
                <!-- Flecha para volver al listado de metas -->
