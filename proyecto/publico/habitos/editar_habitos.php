<?php
// Archivo: publico/habitos/editar_habitos.php
    ...
    <div class="container">
        ...
        <div class="column is-half is-offset-one-quarter">
            <div class="box">
                ...
                <form action="actualizar_habitos.php" method="POST">
                    <!-- Enviar ID para actualizar hábito -->
