<?php
// Archivo: publico/metas/index.php
...
// Traer todas las metas del usuario actual y su habito
...
<section class="section">
  <div class="container">
          ...
          <div class="column is-half">
            <div class="box">
              ...
              <div class="buttons mt-3">
                ...
                <a href="editar_metas.php?id=<?= $meta['id_meta'] ?>" class="button is-info is-small">Editar</a>
                <!-- Botón para eliminar la meta con confirmación -->
                <a href="borrar_metas.php?id=<?= $meta['id_meta'] ?>" class="button is-danger is-small" onclick="return confirm('¿Estás seguro de eliminar esta meta?')">Eliminar</a>
              </div>
            </div>
          </div>
        <?php endforeach; ?>
    ...
    <div class="has-text-centered mt-5">
      <a href="crear_metas.php" class="button is-success is-medium">
